      ...
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        <div className='col-span-8 place-content-center text-center sm:text-left'>
          ...
          <p className='text-[#ADB7BE] mb-6 text-base sm:text-lg lg:text-xl'>
            ...
            Vitae nulla, excepturi corporis libero in nostrum quos saepe laboriosam fugiat iure, sequi minima unde eveniet aliquam earum!
            Nulla porro alias dignissimos.
          </p>
          <div>
